...
// DELETE /api/internal/messages/[id] — apaga uma mensagem do chat interno.
// Só o próprio autor. Não passa pelo WhatsApp — é só limpar no banco.
export async function DELETE(
  ...
  broadcastToUsers(memberIds, {
    type: "internal_message_update",
    data: { id: updated.id, conversationId: updated.conversationId, body: updated.body, mediaUrl: null, mediaType: null },
  })
