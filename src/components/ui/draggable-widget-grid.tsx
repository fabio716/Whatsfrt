...
// Componente de biblioteca (vendored) — mantido igual ao original pra não
// divergir do upstream. As regras abaixo são desligadas DE PROPÓSITO, só aqui:
// ele lê refs durante o render em três pontos, todos deliberados e explicados
// nos comentários do próprio arquivo (`latest` guarda os valores atuais pra
// handlers que sobrevivem ao render, `domOrder` mantém a ordem do DOM fixa pra
// não reiniciar a animação do Motion, e `step` se reagenda via requestAnimationFrame).
// Reescrever isso pra agradar o lint quebraria o algoritmo de arrasto.
